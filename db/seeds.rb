...
Pregunta.create(pregunta: 'Ha tomado nuevos farmacos', tag: 'nuevos farmacos', tipo: true, estado: 1 , descripcion: 'Cuales y en que cantidad')
...
Pregunta.create(pregunta: 'Su excremento cambio a ser un color oscuro', tag: 'color deposicion', tipo: false, estado: 1)
